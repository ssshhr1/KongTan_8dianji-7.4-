...
typedef struct _VCIDEVICEINFO
{
  ...
  UINT16 DriverMajorVersion;   // major driver version number
  UINT16 DriverMinorVersion;   // minor driver version number

  UINT16 HardwareMajorVersion; // major hardware version number
  UINT16 HardwareMinorVersion; // minor hardware version number
  ...
  CHAR Manufacturer[128];      // device manufacturer (e.g: "IXXAT Automation")
