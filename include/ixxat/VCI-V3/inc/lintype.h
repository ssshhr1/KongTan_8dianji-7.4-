...
#define LIN_STATUS_TXPEND    0x01 // transmission pending
#define LIN_STATUS_OVRRUN    0x02 // data overrun occurred
#define LIN_STATUS_ERRLIM    0x04 // error warning limit exceeded
#define LIN_STATUS_BUSOFF    0x08 // bus off status
